...
ImageTexture::ImageTexture(std::string &path, PathType _pathType) : Resource(ResourceType::Linked, path.c_str(), _pathType)
{
...
ImageTexture::ImageTexture(unsigned int _width, unsigned int _height, unsigned char color[4]) : Resource(ResourceType::Embedded)
{
